...
const registEl = document.getElementById("regist");
...
//关闭注册 
registEl.addEventListener('click',()=>{
	swapEl.classList.add('closeregist')
})

window.addEventListener('click',e=>{
	e.target == swapEl?swapEl.classList.remove('closeregist'):false
})

closeEl.addEventListener('click',()=>{
	swapEl.classList.remove('closeregist')
})